  ...
  <div class="table">
    <div class="container">
      ...
      <el-table :data="tables.slice((currentPage-1)*pagesize,currentPage*pagesize)" border style="width: 100%">
          ...
          <el-table-column prop="NAME" label="课程姓名"  align="center" :show-overflow-tooltip="true"></el-table-column>
          <el-table-column prop="FCID" label="先行课" align="center"></el-table-column>
  ...
  export default{
    ...
    methods:{
      getData(){
        ...
        axios.get("/students/courses").then(this.handleStudentInfo)
        // axios({
        //   url:"",
        //   method:"get",
        //   params:{
