    ...
    <div class="container">
      <div class="handle-box top-select-box">
          <div class="top-button">
            <el-button type="primary" icon="search" @click="handleSearch">查询学生选课信息</el-button>
            <el-button type="primary" suffix-icon="add" @click="handleAdd">新增学生选课信息</el-button>
            <el-button type="primary" suffix-icon="add" @click="handleUpdate">更新学生选课信息</el-button>
          </div>
      </div>

      <el-table :data="searchtables.slice((currentPage-1)*pagesize,currentPage*pagesize)" border style="width: 100%" class="searchtables">
          ...
          <el-table-column prop="TID" label="老师编号" align="center"></el-table-column>
      </el-table>
      ...
      <!-- 添加弹出框 -->
      <el-dialog title="新增学生选课信息" :visible.sync="addVisible" width="40%">
        <el-form ref="form" :model="form" label-width="75px">
          <el-form-item label="学生学号">
            <el-input v-model="form.SID" clearable></el-input>
          </el-form-item>
          <el-form-item label="课程号">
            <el-input v-model="form.CID" clearable></el-input>
          </el-form-item>
          <el-form-item label="成绩">
            <el-input v-model="form.SCORE" clearable></el-input>
          </el-form-item>
          <el-form-item label="老师编号">
            <el-input v-model="form.TID" clearable></el-input>
          </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
          <el-button @click="addVisible = false">取 消</el-button>
          <el-button type="primary" @click="addStudent(form.SID,form.CID,form.SCORE,form.TID)">确 定</el-button>
        </span>
      </el-dialog>

      <!-- 查询弹出框 -->
      <el-dialog title="查询学生选课信息" :visible.sync="searchVisible" width="40%">
        <el-form ref="form" :model="form" label-width="75px">
          <el-form-item label="学生学号">
            <el-input v-model="form.SID" clearable></el-input>
          </el-form-item>
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="searchStudent(form.SID)">确 定</el-button>
        </span>
      </el-dialog>

      <!-- 更改弹出框 -->
      <el-dialog title="更新学生选课信息" :visible.sync="updateVisible" width="40%">
         <el-form ref="form" :model="form" label-width="75px">
          <el-form-item label="学生学号">
            <el-input v-model="form.SID" clearable></el-input>
          </el-form-item>
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="updateStudent(form.SID,form.CID,form.SCORE,form.TID)">确 定</el-button>
        </span>
      </el-dialog>
  ...
  export default{
    ...
    computed:{
      ...
      searchtables:function(){
        var search=this.search;
        if(search){
          return  this.searchList.filter(function(dataNews){
            return Object.keys(dataNews).some(function(key){
              return String(dataNews[key]).toLowerCase().indexOf(search) > -1
            })
          })
    ...
    methods:{
      getData(){
        ...
        axios.get("/students/student_courses").then(this.handleStudent_CoursesInfo)
        // axios({
        //   url:"",
        //   method:"get",
        //   params:{
      ...
      //查询学生信息
      searchStudent (SID) {
        axios.post('/students/student_courses_find',{
            SID:this.form.SID
          }).then(this.searchStudent_CoursesInfo)
          this.searchVisible = false;
      },
      //添加学生选课信息
      addStudent (SID,CID,SCORE,TID) {
          axios.post('/students/student_courses_add',{
            SID:this.form.SID,
            CID:this.form.CID,
      ...
      //更改学生选课信息
      updateStudent (SID,CID,SCORE,TID) {
          axios.post('/students/student_courses_update',{
            SID:this.form.SID,
            CID:this.form.CID,
            SCORE:this.form.SCORE,
            TID:this.form.TID,
